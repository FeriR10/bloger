...
<head>
  ...
  <title>Log in - Admin - {{env('APP_NAME')}}</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{asset('assets/AdminLTE')}}/index2.html"><b>Admin</b> {{env('APP_NAME')}}</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Login Admin - {{env('APP_NAME')}}</p>

    <form action="{{route('admin.login.authenticateAdmin')}}" method="post">
      @csrf
